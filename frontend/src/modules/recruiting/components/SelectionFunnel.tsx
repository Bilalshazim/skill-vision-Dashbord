  ...
  return (
    <div className="flex flex-wrap items-center gap-6">
      <div className="relative size-40 shrink-0">
        <svg viewBox="0 0 180 180" className="size-40 -rotate-90">
        ...
        <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center text-center">
          <div className="font-mono text-2xl font-black tabular-nums text-foreground">{centerValue}</div>
          <div className="mt-1 max-w-27.5 text-[10.5px] leading-tight text-muted-foreground">{centerLabel}</div>
        </div>
      </div>
      ...
      {note && <p className="w-full text-[11px] text-muted-foreground">* {note}</p>}
    </div>
  )
}
