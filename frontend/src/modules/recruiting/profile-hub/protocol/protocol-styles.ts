...
export const dashedBtnClass =
  'self-start rounded-md border border-dashed border-border px-3 py-1.5 text-[12px] font-semibold text-primary transition-colors hover:border-ring focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50'
