...
export const UI_EN = {
  ...
  homeOrgTrendModeAvg: 'Average',
  homeOrgTrendModeBenchmark: 'Benchmark',
  ...
  // Home folder cards (client concept): the bold uppercase description lines under the subtitle.
  homeQ1CardLines: ['How much value your company is generating'],
  ...
  homeQ1DeltaChip: (pct) => `${pct} vs. benchmark`,
  homeQ1ViewDetails: 'View Details',
  homeQ1CompareAreas: 'Compare Areas',
  homeQ1ExportReport: 'Export Report',
  homeQ2Kicker: 'WHAT YOU NEVER KNEW',
  homeQ2CardLines: ['Where you need to improve', 'The areas where value stalls'],
  ...
  homeQ3CardLines: ['The value map:', 'Who generates it, where it leaks, how much it is worth in €'],
  ...
  homeQ3ViewAnalysis: 'View analysis',
  homeQ3PeopleUnit: 'people',
  ...
  homeQ4Kicker: 'WHAT YOU CAN DO RIGHT AWAY',
  homeQ4CardLines: ['How to act right away', 'The 3 actions with the greatest impact'],
  ...
  homeQ4PeopleUnit: 'people',
  homeQ4ViewAll: 'View all actions',
  homeQ4PrioritiesKicker: 'Priority actions',
...
export const UI_IT = {
  ...
  homeQ1CardLines: ['Quanto valore sta generando la tua azienda'],
  ...
  homeQ1DeltaChip: (pct) => `${pct} dal benchmark`,
  homeQ1ViewDetails: 'Vedi Dettagli',
  homeQ1CompareAreas: 'Confronta Aree',
  homeQ1ExportReport: 'Esporta Report',
  homeQ2Kicker: 'QUELLO CHE NON AVEVI MAI SAPUTO',
  homeQ2CardLines: ['Dove si deve migliorare', 'Le aree dove il valore si ferma'],
  ...
  homeQ3CardLines: ['La mappa del valore:', 'Chi lo genera, dove si disperde, quanto vale in €'],
  ...
  homeQ3ViewAnalysis: 'Vedi analisi',
  homeQ3PeopleUnit: 'persone',
  ...
  homeQ4CardLines: ['Come agire da subito', 'Le 3 azioni con impatto a maggiore risultato'],
  ...
  homeQ4PeopleUnit: 'persone',
  homeQ4ViewAll: 'Vedi tutte le azioni',
  homeQ4PrioritiesKicker: 'Azioni prioritarie',
